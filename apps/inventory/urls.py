...
urlpatterns = [
    ...
    # Purchase Lists
    path('purchase-lists/', views.purchase_list_index, name='purchase_list_index'),
    path('purchase-lists/new/', views.purchase_list_create, name='purchase_list_create'),
    path('purchase-lists/auto-generate/', views.purchase_list_auto_generate, name='purchase_list_auto_generate'),
    path('purchase-lists/<uuid:pk>/edit/', views.purchase_list_edit, name='purchase_list_edit'),
    path('purchase-lists/<uuid:pk>/confirm/', views.purchase_list_confirm, name='purchase_list_confirm'),
    path('purchase-lists/<uuid:pk>/done/', views.purchase_list_done, name='purchase_list_done'),
    path('purchase-lists/<uuid:pk>/mobile/', views.purchase_list_mobile, name='purchase_list_mobile'),
    path('purchase-lists/<uuid:pk>/lines/<uuid:line_pk>/update-qty/', views.purchase_list_line_update_qty, name='purchase_list_line_update_qty'),
    path('purchase-lists/<uuid:pk>/mobile/add-line/', views.purchase_list_mobile_add_line, name='purchase_list_mobile_add_line'),
    path('purchase-lists/<uuid:pk>/cancel/', views.purchase_list_cancel, name='purchase_list_cancel'),
    # Chatter — Notes & Followers
    path('purchase-lists/<uuid:pk>/notes/', views.purchase_list_notes_list, name='purchase_list_notes_list'),
    path('purchase-lists/<uuid:pk>/notes/create/', views.purchase_list_note_create, name='purchase_list_note_create'),
    path('purchase-lists/<uuid:pk>/followers/', views.purchase_list_followers_api, name='purchase_list_followers_api'),
    path('purchase-lists/<uuid:pk>/followers/<uuid:user_id>/remove/', views.purchase_list_follower_remove, name='purchase_list_follower_remove'),
    path('purchase-lists/bulk-archive/', views.bulk_archive_purchase_lists, name='purchase_list_bulk_archive'),
    path('purchase-lists/bulk-unarchive/', views.bulk_unarchive_purchase_lists, name='purchase_list_bulk_unarchive'),
    path('purchase-lists/bulk-delete/', views.bulk_delete_purchase_lists, name='purchase_list_bulk_delete'),
]
